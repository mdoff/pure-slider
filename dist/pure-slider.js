...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(1), __webpack_require__(38), __webpack_require__(39)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(module, exports, require('babel-runtime/core-js/object/assign'), require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod, mod.exports, global.assign, global.classCallCheck, global.createClass);
	    global.index = mod.exports;
	  }
	})(this, function (module, exports, _assign, _classCallCheck2, _createClass2) {
	  'use strict';
	  ...
	  var PureSlider = function () {
	    function PureSlider() {
	      ...
	      (0, _classCallCheck3.default)(this, PureSlider);
	      ...
	      var options = {};
	      (0, _assign2.default)(options, defaultOptions, props);
	    ...
	    (0, _createClass3.default)(PureSlider, [{
	      key: 'createPlate',
	      value: function createPlate() {
	        var plate = document.createElement('div');
	        var _options = this.options;
	        var rootElement = _options.rootElement;
	        var itemSelector = _options.itemSelector;
	      ...
	      value: function getPlate() {
	        ...
	        var root = _options2.rootElement;
	        var plateClass = _options2.plateClass;
	      ...
	      value: function getItems() {
	        ...
	        var rootElement = _options3.rootElement;
	        var itemSelector = _options3.itemSelector;
	      ...
	      value: function setItemsWidth() {
	        ...
	        var maxItems = _options4.maxItems;
	        var rootElement = _options4.rootElement;
	
	        var width = rootElement.offsetWidth / maxItems;
	      ...
	      value: function initEvents() {
	        ...
	        var root = _options5.rootElement;
	        var goLeftClass = _options5.goLeftClass;
	        var goRightClass = _options5.goRightClass;
	
	        var goLeft = root.querySelector('.' + goLeftClass);
	        var goRight = root.querySelector('.' + goRightClass);
	      ...
	      value: function goRight() {
	        ...
	        var itemsCount = _state2.itemsCount;
...
/***/ }
/******/ ]);
//# sourceMappingURL=pure-slider.js.map